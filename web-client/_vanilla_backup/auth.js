...
async function handleLogin(evt) {
  ...
  try {
    ...
    const msgEl = document.querySelector("#authMessage");
    if (msgEl) {
      msgEl.innerHTML = '登录成功，<a href="https://www.canva.cn/design/DAHF3nwodnI/r9JoGrXZ_FGXG5POJ8MLbg/edit" style="color:inherit;text-decoration:underline;">点击此处跳转</a>';
